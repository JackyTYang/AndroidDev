...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        MultipartBody.Part filePart = MultipartBody.Part.createFormData("image", "cover.png",
        ...
        Call<UploadResponse> response = api.submitMessage(Constants.STUDENT_ID,"",fromPart,toPart,contentPart,filePart,Constants.token);
        response.enqueue(new Callback<UploadResponse>() {
            @Override
            public void onResponse(Call<UploadResponse> call, Response<UploadResponse> response) {
                if(!response.isSuccessful()){
                    Log.d("mytest","response is not successful");
                    ...
                    Log.d("mytest","response is successful");
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
